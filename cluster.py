...
class Node(object):
    ...
    #append the new role into the roles array. 将角色加入roles数组中，即为register
    def register(self, role):
        self.roles.append(roles)

    #remove the role from the roles array. 将角色从数组中移除，实现unregister功能
...
class Timer(object):
    ...
    #sort the self expires and the other expires, cmp(x, y), x<y return -1; x>y return 1; x==y return 0.
